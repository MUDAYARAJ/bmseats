...
<!DOCTYPE html> 
<html lang="en"> 
  <head> <title>Add product information</title>  
                ...
                <?php if(isset($result) && ($data_record) > 0)  : $i=1; ?>
                    <?php  while ($users = mysqli_fetch_object($result)) { ?>
                        ...
                        <tr class="<?=$users->id?>_del">
                            ...
                            <a data="<?php echo  $users->id ?>" title="Delete <?php echo $users->pid;?>" class="tip delete_check btn btn-info btn-sm "><span class="glyphicon glyphicon-remove"></span> </a>  
                            </td>
                        </tr>
                <?php $i++; } ?>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> Products information</h4>
        </div>
        <!-- Form inside modal -->
